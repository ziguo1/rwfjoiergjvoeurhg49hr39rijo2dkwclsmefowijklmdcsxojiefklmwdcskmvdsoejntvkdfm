...
if(typeof window === 'undefined') {
    ...
    (async function() {
      ...
      let registration = await navigator.serviceWorker.register(window.document.currentScript.src, { scope: './' }).catch(e => console.error("COOP/COEP Service Worker failed to register:", e));
      if(registration) {
